...
import smu.squiz.spring.config.RedisUtil;
import org.springframework.mail.javamail.JavaMailSender;
import org.springframework.mail.javamail.MimeMessageHelper;
import smu.squiz.spring.apiPayload.code.status.ErrorStatus;
...
public class EmailService {
    ...
    public String joinEmail(String email) {
        ...
        String toMail = email;
        String title = "Squiz 회원 가입 인증 이메일 입니다."; // 이메일 제목
        String content =
                "Squiz앱을 방문해주셔서 감사합니다." +    //html 형식으로 작성 !
                        "<br><br>" +
